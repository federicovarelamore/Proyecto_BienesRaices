...
<main class="contenedor seccion contenido-centrado">
    <h1 class="titulo-bold">Estilo y diseño moderno de interiores</h1>

    <picture>
        <img loading="lazy" src="/src/img/blog7.jpg" alt="Anuncio">
    </picture>
    ...
    <p>
        ¿Siempre le han fascinado los diseños modernos? ¡Esta nota es para usted!
    </p>
