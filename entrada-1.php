...
<main class="contenedor seccion contenido-centrado">
    <h1 class="titulo-bold">Terraza en el techo de tu casa</h1>

    <picture>
        <img loading="lazy" src="/src/img/blog1.jpg" alt="Entrada de blog">
    </picture>
    ...
    <p>Curabitur in posuere magna. Morbi imperdiet quis libero in scelerisque. Nam ut dolor gravida ipsum
        ...
        lacinia non. Etiam et ornare diam, vel elementum augue. Donec et pharetra magna. Morbi velit dolor.</p>

    <p>consectetur eget est in, interdum condimentum libero. Vivamus sollicitudin a risus ac dapibus. Proin
        ...
        suscipit diam at tellus suscipit, at placerat neque vulputate. Sed id augue non ipsum lacinia lacinia at</p>

    <p>fermentum nulla. Nulla magna diam, suscipit quis aliquam nec, maximus eu orci. Nunc porttitor massa et
